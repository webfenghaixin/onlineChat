...
export default function DrawPage({
  ...
  const drawHistoryPane = (
    <>
      <button type="button" className="desktop-new-conv-btn" onClick={createNewDrawConversation}>
        新建画图
      </button>
      <div className="desktop-history-list">
        {drawConversations
          ...
          .map((conv) => (
            <div
              key={conv.id}
              className={`desktop-history-item ${conv.id === activeDrawConversationId ? 'active' : ''}`}
            >
              <button
              ...
              >
                <span className="desktop-history-title">{conv.title}</span>
  ...
  return (
    <div className="desktop-draw-page">
      ...
      <main className="desktop-draw-main">
        ...
        <div className="message-list-wrapper">
          ...
          {composerCollapsed && !drawSelectMode && (
            <button
              type="button"
              className="composer-fab composer-fab-visible"
